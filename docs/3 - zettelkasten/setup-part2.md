...
> [!TIP]
> Below is a pre-made template for you to use with your Zettelkasten system.
...
> [!INFO]
> I'll explain what each section of the template means. If you want to skip this explanation and just copy-paste the template, feel free to jump ahead.
...
3. Drag this file to the "5 - Template" folder (or right-click and select "Move File to...")
...
> 
> In the next section, we'll explore practical ways to use your new Zettelkasten system.
